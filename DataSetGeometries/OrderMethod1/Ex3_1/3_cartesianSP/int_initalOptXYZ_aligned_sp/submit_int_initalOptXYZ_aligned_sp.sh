...
#SBATCH -J int_initalOptXYZ_aligned_sp
#SBATCH -n 12
#SBATCH -N 1
#SBATCH -p standard
...
# run Gaussian
ulimit -c 0
g16 int_initalOptXYZ_aligned_sp.gjf int_initalOptXYZ_aligned_sp.out
...
cp int_initalOptXYZ_aligned_sp.out ../../5_dipoleCalculation/cart_int_initalOptXYZ_aligned_sp.out
